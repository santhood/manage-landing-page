...
const social_media = [
  { route: "#", alt: "Facebook", icon: "/images/icon-facebook.svg" },
  { route: "#", alt: "Youtube", icon: "/images/icon-youtube.svg" },
  { route: "#", alt: "Twitter", icon: "/images/icon-twitter.svg" },
  {
    route: "#",
    alt: "Pinterest",
...
export default function Footer() {
  ...
  return (
    <footer className="section bg-neutral-400 py-12 text-neutral-100">
      <div className="container grid grid-flow-dense grid-cols-1 gap-12 lg:grid-cols-[200px_1fr_auto] lg:items-start">
        <form
          noValidate
          onSubmit={handleSubmit}
          className="grid grid-cols-[1fr_auto] gap-x-4 lg:col-[3/4]"
        >
          <div className="relative">
            <input
              ...
              className={`${emailError ? "border-red-500" : ""} h-full rounded-full border-2 px-6 text-neutral-400 outline-none`}
            />
            {emailError && (
              <span className="absolute left-0 top-full block px-6 pt-2 text-sm text-red-500">
          ...
          <button
            type="submit"
            className="rounded-full bg-primary-100 px-6 py-1.5"
          >
            GO
          </button>
        </form>
        ...
        <a href="/" className="mx-auto lg:col-[1/2] lg:row-[1/2] lg:mx-0">
        ...
        <span className="text-center text-sm text-neutral-300 lg:col-[3/4]">
